...
3dvolreg  -Fourier -twopass -base ${rest}_ro_mean.nii.gz -zpad 4 -prefix ${rest}_mc.nii.gz -dfile ${rest}_mc_rms.1D -maxdisp1D ${rest}_mc_maxdsp.1D -1Dfile ${rest}_mc.1D ${rest}_ro.nii.gz
...
3dcalc -a ${rest}_ss.nii.gz[7] -expr 'a' -prefix ${rest}_example_func.nii.gz
