...
# big test data
filena   = '/data/pt_mar006/jetze.h5'
corr_All = np.array(h5py.File(filena, 'r')['corr_All'])
corr_All = corr_All.T
...
np.savetxt('/data/pt_mar006/kenW_tied_python.txt', W_voxels)

np.savetxt('/data/pt_mar006/ccc_python.txt', ccc_voxels)

np.savetxt('/data/pt_mar006/icc_python.txt', ICC_voxels)
