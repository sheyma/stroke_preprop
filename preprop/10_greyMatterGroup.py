"""
get GM probability map across healthy participants 
get epi brain mask across healthy participants
get the overlap between GM map and epi mask 
binarize the overlap to get a final mask
### the final mask used to get connectivity gradients!
