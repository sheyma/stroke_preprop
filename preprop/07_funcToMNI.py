"""
    # registration from epi image to mni template
    # bbregister and ants transformation matrices used at single interpolation
    # if subjects have multiple epi images, then first register epi images:
    # rest -> rest(dayXX) -> T1 -> mni
